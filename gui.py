...
class HelloFrame(wx.Frame):
    ...
    def __init__(self,*args,**kw):
        ...
        self.pnl = pnl
        st = wx.StaticText(pnl, label="状态", pos=(200, 0))
        font = st.GetFont()
        font.PointSize += 10
        font = font.Bold()
        st.SetFont(font)
        ...
        self.SetStatusText("Welcome to elevator door status recognition")
...
if __name__ == '__main__':
    ...
    app = wx.App()
    frm = HelloFrame(None, title='elevator door ', size=(1000,600))
    frm.Show()
    app.MainLoop()